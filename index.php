...
<html lang="en">
    ...
    <body class="bg-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="KodeLogin" name="KodeLogin" type="text" placeholder="Ketik Kode Login Anda" />
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <button class="btn btn-primary" name="bLogin">Login</button>
                                            </div>
        ...
        <?php if (isset($_POST['bLogin'])) {
            ...
            $sqllogin="select * from Pengguna where KodePengguna='".$KodeLogin."' and Password='".$inputPassword."'";
            $qlogin=mysqli_query($koneksi,$sqllogin);
            $rlogin=mysqli_fetch_array($qlogin);
            if (!empty($rlogin)) {
